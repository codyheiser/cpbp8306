...
# example outputs from console for given 24-mer files below:
'''
$ python Heiser_7.py 24mer_A.txt 

Sequence:
    3`-CGCGCGCGAATTCGCGCGCGAATT-5`

Reverse compliment:
    3`-AATTCGCGCGCGAATTCGCGCGCG-5`

RNA reverse compliment:
    3`-AAUUCGCGCGCGAAUUCGCGCGCG-5`

Length: 24 bp

Base counts: {'A': 4, 'T': 4, 'C': 8, 'G': 8}

GC content: 66.667 %

Melting temperature (Tm): 64.217 C

Molar mass: 7354.8 g/mol
'''

'''
$ python Heiser_7.py 24mer_B.txt 

Sequence:
    3`-CGCGAATTGCGCTTAACGCGAATT-5`

Reverse compliment:
    3`-AATTCGCGTTAAGCGCAATTCGCG-5`

RNA reverse compliment:
    3`-AAUUCGCGUUAAGCGCAAUUCGCG-5`

Length: 24 bp

Base counts: {'A': 6, 'T': 6, 'C': 6, 'G': 6}

GC content: 50.0 %

Melting temperature (Tm): 57.383 C

Molar mass: 7352.84 g/mol
'''
